...
const MultipleInstagramEmbeds = () => {
  ...
  return (
      ...
      <div className="grid bg-transparent laptop:grid-cols-3 laptop:grid-row-2  mobile:grid-row-5 mobile:py-10 mobile:grid-cols-2">
        {instagramUrls.map((url, index) => (
          <div key={index} className="  laptop:w-[360px]  laptop:gap-4  mb-12 mr-10 drop-shadow-[0_20px_20px_rgba(0,0,0,0.85)]">
