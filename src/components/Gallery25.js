...
const ImageGallery = () => {
  ...
  return (
    <div className="relative inset-0 bg-cover h-screen w-full bg-fixed overflow-y-scroll " style={{ backgroundImage: `url(${Imgbg})` }}>
      <h1 className='text-yellow-300 font-GillCondensedB font-semibold text-3xl drop-shadow-[0_10px_10px_rgba(0,0,0,10)]'>Galeria de Imagens: 25/10/2024</h1>
      ...
      <div>
        <img className='absolute bg-fixed opacity-60 top-48 right-56 w-[700px]' src={Logo} alt="" />
